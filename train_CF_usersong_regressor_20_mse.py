...
parser.add_argument("-s","--save_path",type=str, default="./save/exp_cf_20_mlp_reg1/")
parser.add_argument("--cf_feat_path", type=str, 
                    default="./data/user_song_feat_201905/features_spotify_id_20.npy")
parser.add_argument("--audio_feat_path", type=str, default="./data/audio_featmtx_20.npy")
